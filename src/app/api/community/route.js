...
import { databases, databaseId, communityCollectionId } from "@/lib/appwrite";
...
export async function GET(request) {
  try {
    ...
    console.log(
      "Fetching community with queries (BYPASSING ACADEMIC PERIOD):",
      {
        page,
        limit,
        includeArchived,
...
// Handle POST requests for creating new community members
